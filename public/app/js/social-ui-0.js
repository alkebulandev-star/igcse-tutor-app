...
(function(){
  ...
  var CLASS_LABEL = { kids:'🧒 Kids (KS1–KS2)', juniors:'📘 Lower Secondary (KS3)', seniors:'🎓 IGCSE / A-Level (KS4–KS5)', prep:'🏆 Exam Prep' };
  var CLASS_LIST = [
    { id:'kids', name:'Kids (Pre-Primary · P1-6)' },
    { id:'juniors', name:'Juniors (Year 7-3)' },
    { id:'seniors', name:'Seniors (Year 10-3)' },
    { id:'prep', name:'Exam Prep (Cambridge · Edexcel · A-Level / UCAS)' }
  ];
  ...
  function renderProfile(){
    ...
    var FAVS = ['Maths','English','Physics','Chemistry','Biology','Geography','History','RS','RS','Lit','Economics','Govt','Agric','ICT','Art','French','Yoruba','Spanish','Mandarin'];
    return ''
      + '<div class="sc-card">'
      ...
      +   '<label class="sc-label">School (optional)</label><input class="sc-input" id="scInSchool" maxlength="80" value="'+esc(me.school||'')+'" placeholder="e.g. Kings College London">'
      +   '<label class="sc-label">State</label><input class="sc-input" id="scInState" maxlength="40" value="'+esc(me.state||'')+'" placeholder="e.g. London">'
