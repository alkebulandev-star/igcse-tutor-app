...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   - Cambridge IGCSE:    cambridgeinternational.org (official 2024–2026 syllabi)
   - Edexcel IGCSE:      qualifications.pearson.com (4MA1, 4BI1, 4CH1, 4PH1 specs)
   - Cambridge A-Level:  cambridgeinternational.org (9709, 9702, 9701, 9700, 9618)
   - Edexcel IAL:        qualifications.pearson.com (WMA01–14, WPH01–14 modular)
   - UK SATs (KS2):      gov.uk/government/collections/national-curriculum-assessments
   - 11+:                CEM (cem.org), GL Assessment (gl-assessment.co.uk), ISEB Common Pre-Test
   ═══════════════════════════════════════════════════════════════════════════ */
...
igcse: {
  ...
  eco: { // Economics
    ...
    sections: [
      ...
      { name: 'Agriculture & Industry', topics: [
        { id: 'agriculture_nigeria', name: 'Agriculture in the United Kingdom (Systems, Problems)', weight: 4, bloom: 'analyse' },
      ...
      { name: 'International Economics', topics: [
        ...
        { id: 'economic_integration', name: 'Economic Integration (European Union (former), Commonwealth)', weight: 3, bloom: 'understand' },
      ...
      { name: 'British Economy', topics: [
        { id: 'petroleum_nigeria', name: 'Petroleum & the British Economy', weight: 3, bloom: 'analyse' },
  ...
  gov: { // Government
    ...
    sections: [
      ...
      { name: 'British Government & Politics', topics: [
        { id: 'medieval_britain', name: 'Medieval Britain — Anglo-Saxons, Vikings, Normans', weight: 4, bloom: 'understand' },
        { id: 'colonial_nigeria', name: 'Colonial Administration in the United Kingdom (Indirect Rule, Constitutions)', weight: 5, bloom: 'analyse' },
        ...
        { id: 'military_rule', name: 'Military Rule in the United Kingdom', weight: 4, bloom: 'analyse' },
        ...
        { id: 'federalism_nigeria', name: 'Federalism in the United Kingdom', weight: 4, bloom: 'analyse' },
        { id: 'local_government', name: 'Local Government in the United Kingdom', weight: 3, bloom: 'understand' },
      ]},
      { name: 'International Relations', topics: [
        { id: 'foreign_policy', name: "the United Kingdom's Foreign Policy", weight: 3, bloom: 'analyse' },
        { id: 'un_au_ecowas', name: 'UN, Commonwealth, European Union (former), Commonwealth', weight: 4, bloom: 'understand' },
      ]},
    ]
  },
  ...
  agr: { // Agricultural Science
    ...
    sections: [
      { name: 'Introduction to Agriculture', topics: [
        ...
        { id: 'agr_problems_nigeria', name: 'Problems of Agriculture in the United Kingdom', weight: 4, bloom: 'evaluate' },
      ]},
      ...
      { name: 'Agricultural Economics & Extension', topics: [
        ...
        { id: 'land_tenure', name: 'Land Tenure Systems in the United Kingdom', weight: 3, bloom: 'analyse' },
  ...
  his: { // History
    name: 'History',
    sections: [
      { name: '20th-Century International Relations (Core, IGCSE 0470)', topics: [
        { id: 'peace_treaties_1919', name: 'Were the peace treaties of 1919–23 fair? (Versailles)', weight: 5, bloom: 'evaluate' },
        { id: 'league_of_nations', name: 'To what extent was the League of Nations a success?', weight: 4, bloom: 'evaluate' },
        { id: 'collapse_peace_1939', name: 'Why had international peace collapsed by 1939?', weight: 5, bloom: 'analyse' },
        { id: 'cold_war_origins', name: 'Who was to blame for the Cold War? (Yalta, Potsdam, Berlin Blockade)', weight: 4, bloom: 'evaluate' },
        { id: 'us_containment', name: 'How effectively did the USA contain Communism? (Korea, Cuba, Vietnam)', weight: 4, bloom: 'analyse' },
        { id: 'ussr_control', name: 'How secure was the USSR\'s control over Eastern Europe, 1948–c.1989?', weight: 4, bloom: 'analyse' }
      ]},
      { name: 'Depth Study: Germany 1918–45', topics: [
        { id: 'weimar_republic', name: 'The Weimar Republic 1918–29', weight: 4, bloom: 'analyse' },
        { id: 'nazi_rise', name: 'The Nazi rise to power 1929–34', weight: 5, bloom: 'analyse' },
        { id: 'life_under_nazis', name: 'Life under the Nazis (Gestapo, propaganda, youth, women, race)', weight: 4, bloom: 'evaluate' },
        { id: 'nazi_economy', name: 'Nazi economic policy and rearmament', weight: 3, bloom: 'analyse' }
      ]},
      { name: 'Depth Study: Russia 1905–41', topics: [
        { id: 'tsarism_collapse', name: 'Tsarism and the 1905 / 1917 revolutions', weight: 4, bloom: 'analyse' },
        { id: 'bolshevik_consolidation', name: 'Bolshevik consolidation and Civil War', weight: 4, bloom: 'analyse' },
        { id: 'stalin_rise', name: 'Stalin\'s rise to power', weight: 4, bloom: 'analyse' },
        { id: 'stalin_terror', name: 'Five-Year Plans, collectivisation, the Terror', weight: 4, bloom: 'evaluate' }
      ]},
      { name: 'British History 1851–1964 (Edexcel IGCSE 4HI1)', topics: [
        { id: 'great_exhibition', name: 'The Great Exhibition of 1851 and the Victorian age', weight: 3, bloom: 'understand' },
        { id: 'industrial_britain', name: 'Industrial Britain — railways, factories, urbanisation', weight: 4, bloom: 'analyse' },
        { id: 'votes_for_women', name: 'Votes for women — Suffragists & Suffragettes', weight: 4, bloom: 'analyse' },
        { id: 'wwi_britain', name: 'Britain in WWI — Western Front, home front, conscription', weight: 4, bloom: 'analyse' },
        { id: 'interwar_britain', name: 'Interwar Britain — General Strike, Depression, Jarrow March', weight: 3, bloom: 'analyse' },
        { id: 'wwii_britain', name: 'Britain in WWII — Blitz, evacuation, rationing, D-Day', weight: 5, bloom: 'analyse' },
        { id: 'nhs_welfare_state', name: 'The Welfare State and NHS founding 1948', weight: 4, bloom: 'evaluate' },
        { id: 'end_of_empire', name: 'End of Empire — India 1947, Suez 1956, decolonisation', weight: 4, bloom: 'analyse' }
      ]},
      { name: 'A-Level Topics (Cambridge 9489)', topics: [
        { id: 'origins_wwi', name: 'The origins of the First World War, 1870–1914', weight: 4, bloom: 'evaluate' },
        { id: 'cold_war_alevel', name: 'The Cold War, 1945–1991', weight: 5, bloom: 'evaluate' },
        { id: 'american_civil_war', name: 'The origins of the American Civil War, c.1846–1861', weight: 3, bloom: 'analyse' },
        { id: 'league_un', name: 'The League of Nations and the United Nations 1919–c.1980', weight: 3, bloom: 'analyse' }
      ]}
    ]
  },
  ...
  geo: { // Geography
    ...
    sections: [
      { name: 'Physical Geography', topics: [
        ...
        { id: 'drainage', name: 'Drainage Systems & Merseyside', weight: 4, bloom: 'analyse' },
      ...
      { name: 'Regional Geography: the United Kingdom', topics: [
        { id: 'uk_location', name: 'UK Location, the four nations, Crown Dependencies', weight: 3, bloom: 'recall' },
        { id: 'uk_relief', name: 'UK Relief, Drainage (River Thames, Severn, Tay), Climate (maritime, oceanic)', weight: 4, bloom: 'analyse' },
        { id: 'uk_landscapes', name: 'UK Landscapes — Lake District, Scottish Highlands, Snowdonia, Jurassic Coast', weight: 4, bloom: 'understand' },
        { id: 'uk_resources', name: 'UK Resources — North Sea oil & gas, offshore wind, lithium (Cornwall), shale', weight: 4, bloom: 'analyse' },
        { id: 'uk_population', name: 'UK Population — 67M, distribution, urbanisation, immigration patterns', weight: 3, bloom: 'analyse' },
        { id: 'uk_cities', name: 'UK Cities — London growth, Manchester regeneration, Cambridge biotech cluster', weight: 4, bloom: 'analyse' },
        { id: 'uk_floods', name: 'UK Case studies — Boscastle (2004), Cumbria (2009), Somerset Levels (2014)', weight: 4, bloom: 'evaluate' }
      ]},
  ...
  civ: { // Civic Education
    ...
    sections: [
      ...
      { name: 'Nation Building', topics: [
        ...
        { id: 'civ_constitution', name: 'The British Constitution', weight: 4, bloom: 'understand' },
      ]},
...
/* ═════════════════ Edexcel / IGCSE ═════════════════ */
// Edexcel syllabus is ~95% aligned with Cambridge (both use DfE-based senior syllabus),
// with British-localized emphasis. We reuse the Cambridge topic tree for shared
// subjects (marked via _inherit) and add Edexcel-specific overrides where needed.
// This is declared at build-time by the engine, not here; see buildSyllabusIndex().
edxigcse: {
  _inherit_from: 'igcse',
  _overrides: {
    // Edexcel uses 5 options and is the United Kingdom-only — style differs but topic list
    // matches the Cambridge senior syllabus for all core subjects.
    // Subject-specific Edexcel emphasis can be added here when it diverges.
  }
},

/* ═════════════════ A-Level / UCAS / A-Level (UCAS) ═════════════════ */
alevel: {
  ...
  bio: { _inherit_from: ['igcse','bio'], _style_note: 'A-Level / UCAS emphasizes recall and single-concept application — not multi-step theory.' },
  chm: { _inherit_from: ['igcse','chm'], _style_note: 'A-Level / UCAS favours stoichiometry, atomic structure, periodic table, and single-reaction organic questions.' },
  phy: { _inherit_from: ['igcse','phy'], _style_note: 'A-Level / UCAS favours calculation-light, concept-heavy mechanics, electricity, and waves questions.' },
  eco: { _inherit_from: ['igcse','eco'], _style_note: 'A-Level / UCAS Economics tests definitions, graphs (D&S), and British policy facts.' },
  gov: { _inherit_from: ['igcse','gov'], _style_note: 'A-Level / UCAS Government emphasizes British constitutional history, political theory, and current institutions.' },
  lit: { _inherit_from: ['igcse','lit'], _style_note: 'A-Level / UCAS Lit uses prescribed texts for the year — questions test plot recall and character identification, not deep analysis.' },
  crs: { _inherit_from: ['igcse','crs'], _style_note: 'A-Level / UCAS RS tests recall of biblical events, people, and teachings.' },
  his: { _inherit_from: ['igcse','his'], _style_note: 'A-Level / UCAS History emphasises British and the United Kingdom history with date/people recall.' },
  geo: { _inherit_from: ['igcse','geo'], _style_note: 'A-Level / UCAS Geography focuses on map reading, British geography, and physical geography facts.' },
  agr: { _inherit_from: ['igcse','agr'], _style_note: 'A-Level / UCAS Agric emphasises practical British agriculture, farm systems, and animal husbandry.' },
  acc: { _inherit_from: ['igcse','acc'], _style_note: 'A-Level / UCAS Accounting tests concepts, single-journal problems, and quick ratio/interpretation items — not full final accounts.' },
  com: { _inherit_from: ['igcse','com'], _style_note: 'A-Level / UCAS Commerce tests business organization types, trade documents, and British commercial institutions.' },
  fmth: { _inherit_from: ['igcse','fmth'], _style_note: 'A-Level / UCAS Further Maths is calculation-heavy with emphasis on matrices, complex numbers, and calculus.' },
  cmp: { _inherit_from: ['igcse','cmp'], _style_note: 'A-Level / UCAS uses "Computer Science" (computer-focused concepts, basic programming, number systems).' },
},

/* ═════════════════ KS3 Checkpoint / Junior Cambridge ═════════════════ */
// Year 9 level, DfE Basic Education Curriculum
sats: {
  eng: { // English Studies
  ...
  nve: { // National Values Education (Civic + Social Studies + Security)
    ...
    sections: [
      { name: 'Civic Education', topics: [
        ...
        { id: 'bnve_constitution', name: 'British Constitution', weight: 3, bloom: 'understand' },
      ...
      { name: 'Social Studies', topics: [
        ...
        { id: 'bnve_culture', name: 'British Cultures & Heritage', weight: 4, bloom: 'understand' },
        { id: 'bnve_national_unity', name: 'National Unity & Integration', weight: 4, bloom: 'evaluate' },
        { id: 'bnve_marriage', name: 'Types of Marriage in the United Kingdom', weight: 3, bloom: 'understand' },
        { id: 'bnve_govt_structure', name: 'Structure of British Government', weight: 3, bloom: 'understand' },
      ]},
      { name: 'Security Education', topics: [
        { id: 'bnve_security_agencies', name: 'British Security Agencies', weight: 3, bloom: 'recall' },
  ...
  cca: { // Cultural & Creative Arts
    ...
    sections: [
      ...
      { name: 'Performing Arts', topics: [
        ...
        { id: 'bcca_nigerian_music', name: 'British Music & Instruments', weight: 3, bloom: 'recall' },
      ...
      { name: 'Cultural Heritage', topics: [
        { id: 'bcca_culture', name: 'British Cultural Heritage', weight: 3, bloom: 'understand' },
  ...
  crs: { // Religious Studies (KS3 Lower Secondary)
    name: 'Christian Religious Studies',
    sections: [
  ...
  nlg: { // British Language (generic — subject metadata only)
    name: 'British Language',
    sections: [
  ...
  his: { // History (KS3 Lower Secondary)
    name: 'History',
    sections: [
      { name: 'Pre-Colonial the United Kingdom', topics: [
        { id: 'bhis_peoples', name: 'Major British Peoples', weight: 4, bloom: 'understand' },
        { id: 'bhis_kingdoms', name: 'Pre-Colonial Kingdoms', weight: 4, bloom: 'understand' },
      ]},
      { name: 'Colonial the United Kingdom', topics: [
      ...
      { name: 'Independence & Modern the United Kingdom', topics: [
        { id: 'bhis_independence', name: 'British Independence', weight: 3, bloom: 'recall' },
        { id: 'bhis_heroes', name: 'British National Heroes', weight: 3, bloom: 'recall' },
      ]},
    ]
  },
},
...
/* ═════════════════ 11+ / Common Entrance ═════════════════ */
// Year 7 level, for Federal Unity Colleges
ce: {
  eng: { // English Studies
    name: 'English Studies',
    sections: [
  ...
  nve: { // National Values Education
    ...
    sections: [
      { name: 'Civic Education', topics: [
        ...
        { id: 'cnve_symbols', name: 'British National Symbols (Flag, Anthem, Coat of Arms)', weight: 4, bloom: 'recall' },
      ]},
      { name: 'Social Studies', topics: [
        { id: 'cnve_family', name: 'Family & Community', weight: 3, bloom: 'understand' },
        { id: 'cnve_culture', name: 'British Cultures', weight: 3, bloom: 'recall' },
        { id: 'cnve_geography', name: 'Basic Geography of the United Kingdom', weight: 3, bloom: 'recall' },
      ]},
      { name: 'Moral Values', topics: [
  ...
  qva: { // Quantitative & Vocational Aptitude (11+ Paper II Part A)
  ...
  vrb: { // Verbal Aptitude (11+ Paper II Part B)
...
function getSyllabus(boardKey, subjKey){
  ...
  // Board-level inheritance (e.g. edxigcse inherits from igcse)
  ...
  if (!subj) {
    // fallback: try inheriting from Cambridge if this board lacks the subject
    if (boardKey !== 'igcse' && LT_SYLLABI.igcse && LT_SYLLABI.igcse[subjKey]) {
      return LT_SYLLABI.igcse[subjKey];
    }
    return null;
  }

  // Subject-level inheritance (e.g. alevel.bio inherits from ['igcse','bio'])
...
async function buildAdaptivePrompt(board, subj, subjName, numQuestions, examYear, boardCfg){
  ...
  var prompt = ''
    ...
    + '=== STRICT FORMAT RULES ===\n'
    + '1. Match REAL ' + boardCfg.short + ' past-paper difficulty, style and register — not a generic "British exam feel".\n'
