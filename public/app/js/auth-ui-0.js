...
function openAuthModal(opts){
  ...
  function render(mode){
    ...
    if (mode === 'signup'){
      ...
      fStudent.innerHTML =
        '<div class="lt-field">' +
          ...
          '<select id="ltAuthSection">' +
            ...
            '<option value="kids">Kids Zone (Ages 4–10 · EYFS)</option>' +
            '<option value="primary">Primary (KS1–KS2 · Year 1–6)</option>' +
            '<option value="jss">Lower Secondary (KS3 · Year 7–9)</option>' +
            '<option value="sss">IGCSE &amp; A-Level (KS4–KS5 · Year 10–13)</option>' +
          '</select>' +
        '</div>' +
        '<div class="lt-field">' +
          '<label>Class</label>' +
          ...
          '<div class="lt-field"><label>Region</label>' +
            '<select id="ltAuthState"><option value="">—</option>' +
              [
                ...
                'East Midlands','West Midlands','Yorkshire & the Humber','North East England',
                'North West England','Scotland','Wales','Northern Ireland',
                'International — UAE','International — Singapore','International — Hong Kong',
                'International — Malaysia','International — Switzerland','International — Spain',
                'International — Germany','International — India','International — China',
                'International — Saudi Arabia','International — Egypt','International — Brazil',
                'International — Australia','International — Canada','International — USA',
                'International — Other'
      ...
      // Wire section → class options (British year-group labels; internal vals stay stable)
      var classOpts = {
        kids:    [['early','Ages 4–6'],['upper','Ages 7–10']],
        primary: [['P1','Year 1'],['P2','Year 2'],['P3','Year 3'],['P4','Year 4'],['P5','Year 5'],['P6','Year 6']],
        jss:     [['Year 7','Year 7'],['Year 8','Year 8'],['Year 9','Year 9']],
        sss:     [['SS1','Year 10 · IGCSE'],['SS2','Year 11 · IGCSE'],['SS3','Year 12 · AS-Level'],['SS3','Year 13 · A-Level']]
      };
