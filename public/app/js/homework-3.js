...
// ─── UK MAP DATA — Counties / regions of the United Kingdom ──────
// Zones: ENG-S (Southern England), ENG-M (Midlands), ENG-N (Northern England),
// SCT (Scotland), WLS (Wales), NIR (Northern Ireland), LDN (Greater London)
var NIG_STATES = [
  {n:'Greater London',    c:'London',        z:'LDN'},
  {n:'Kent',              c:'Maidstone',     z:'ENG-S'},
  {n:'Surrey',            c:'Guildford',     z:'ENG-S'},
  {n:'Hampshire',         c:'Winchester',    z:'ENG-S'},
  {n:'East Sussex',       c:'Lewes',         z:'ENG-S'},
  {n:'West Sussex',       c:'Chichester',    z:'ENG-S'},
  {n:'Berkshire',         c:'Reading',       z:'ENG-S'},
  {n:'Oxfordshire',       c:'Oxford',        z:'ENG-S'},
  {n:'Cornwall',          c:'Truro',         z:'ENG-S'},
  {n:'Devon',              c:'Exeter',       z:'ENG-S'},
  {n:'Somerset',          c:'Taunton',       z:'ENG-S'},
  {n:'Dorset',             c:'Dorchester',   z:'ENG-S'},
  {n:'Bristol',            c:'Bristol',      z:'ENG-S'},
  {n:'Essex',              c:'Chelmsford',   z:'ENG-S'},
  {n:'Cambridgeshire',     c:'Cambridge',    z:'ENG-S'},
  {n:'West Midlands',      c:'Birmingham',   z:'ENG-M'},
  {n:'Warwickshire',       c:'Warwick',      z:'ENG-M'},
  {n:'Leicestershire',     c:'Leicester',    z:'ENG-M'},
  {n:'Nottinghamshire',    c:'Nottingham',   z:'ENG-M'},
  {n:'Derbyshire',         c:'Matlock',      z:'ENG-M'},
  {n:'Staffordshire',      c:'Stafford',     z:'ENG-M'},
  {n:'Greater Manchester', c:'Manchester',   z:'ENG-N'},
  {n:'Merseyside',         c:'Liverpool',    z:'ENG-N'},
  {n:'West Yorkshire',     c:'Leeds',        z:'ENG-N'},
  {n:'South Yorkshire',    c:'Sheffield',    z:'ENG-N'},
  {n:'Tyne and Wear',      c:'Newcastle',    z:'ENG-N'},
  {n:'Lancashire',         c:'Preston',      z:'ENG-N'},
  {n:'Cumbria',            c:'Carlisle',     z:'ENG-N'},
  {n:'Edinburgh',          c:'Edinburgh',    z:'SCT'},
  {n:'Glasgow',            c:'Glasgow',      z:'SCT'},
  {n:'Aberdeenshire',      c:'Aberdeen',     z:'SCT'},
  {n:'Highland',           c:'Inverness',    z:'SCT'},
  {n:'Cardiff',            c:'Cardiff',      z:'WLS'},
  {n:'Swansea',            c:'Swansea',      z:'WLS'},
  {n:'Gwynedd',            c:'Caernarfon',   z:'WLS'},
  {n:'Belfast',            c:'Belfast',      z:'NIR'},
  {n:'County Antrim',      c:'Ballymena',    z:'NIR'},
  {n:'County Down',        c:'Downpatrick',  z:'NIR'}
];
...
function renderNigStates(){
  ...
  list.innerHTML=filtered.map(function(s){return '<div class="nig-state"><div><div class="nig-state-name">'+s.n+'</div><div class="nig-state-cap">Capital / main town: '+s.c+'</div></div><span class="nig-state-zone">'+s.z+'</span></div>';}).join('');
}
...
(function(){
  ...
  window.toggleTool=function(id){
    ...
    if(panel && panel.style.display!=='none'){
      ...
      if(id==='toolUKMap') renderNigStates();
