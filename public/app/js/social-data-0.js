...
(function(){
  ...
  function seedIfEmpty(){
    ...
    profiles = {};
    var seeds = [
      { name:'Oliver T.',   avatar:'🦊', classGroup:'seniors', school:'Eton College',                          state:'South East England', fav:['Maths','Physics'],   bio:'Year 12 · loves Mechanics' },
      { name:'Amelia W.',   avatar:'🦅', classGroup:'seniors', school:'Westminster School',                    state:'London',             fav:['English Lit','History'], bio:'IGCSE mocks done — A-Level inbound 💪' },
      { name:'Harry P.',    avatar:'🦋', classGroup:'juniors', school:'Dulwich College',                       state:'London',             fav:['Biology','Chemistry'], bio:'Year 9 · prefect' },
      { name:'Sophia K.',   avatar:'🐯', classGroup:'juniors', school:'St Paul\'s Girls\' School',             state:'London',             fav:['Maths','Geography'], bio:'KS3 Checkpoint top set' },
      { name:'Mohammed A.', avatar:'🦄', classGroup:'prep',    school:'British School of Brussels',            state:'International (Belgium)', fav:['A-Level','Maths'], bio:'Year 13 · Oxbridge prep 📚' },
      { name:'Aaliyah J.',  avatar:'🐼', classGroup:'kids',    school:'Cheltenham Ladies\' College',           state:'South West England', fav:['English','Art'],     bio:'Year 5 · I love drawing' },
      { name:'Chen L.',     avatar:'🐧', classGroup:'kids',    school:'Singapore International School',        state:'International (Singapore)', fav:['Maths','Science'], bio:'Year 6 · SATs ready' },
      { name:'Priya R.',    avatar:'🦖', classGroup:'seniors', school:'Dubai British School',                  state:'International (UAE)',    fav:['Chemistry','Biology'], bio:'Year 12 · future medic' },
      { name:'Lucas H.',    avatar:'🐨', classGroup:'seniors', school:'King\'s School Canterbury',             state:'South East England', fav:['Computer Science','Maths'], bio:'A-Level CS · Imperial dream' },
      { name:'Emma S.',     avatar:'🦢', classGroup:'juniors', school:'Edinburgh Academy',                     state:'Scotland',           fav:['Modern Languages','History'], bio:'Year 10 · French A* mock' },
      { name:'Noah B.',     avatar:'🐬', classGroup:'kids',    school:'International School of London',        state:'London',             fav:['Maths','PE'],        bio:'Year 4 · times tables champion' },
      { name:'Mia W.',      avatar:'🦒', classGroup:'prep',    school:'Charterhouse School',                   state:'South East England', fav:['Economics','Politics'], bio:'Year 13 · LSE applicant' }
    ];
  ...
  function getMe(){
    ...
    if (!me){
      me = { id: uid(), name:'You', avatar:'🦁', classGroup:'seniors', school:'', state:'London', fav:[], bio:'', joinedAt: now(), board:'igcse' };
      write(KEY_ME, me);
  ...
  function filter(text){
    ...
    // Phone numbers (UK-friendly: 07..., +44..., 11-digit, with spaces/dashes; works for any country code)
