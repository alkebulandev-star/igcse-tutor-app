...
(function(){
  ...
  var TOURS = {
    learning: [
      { sel:'.sb-class-pick, [id*="classPicker"], .cl-side',
        ...
        body:'Open the side menu to choose your year group (Primary, Key Stage 3, or IGCSE/A-Level) and the subject you want to study.' },
      { sel:'#lessonContent, #lessonArea, .lesson-panel',
        title:'2. Read the AI lesson',
        body:'The lesson appears here — definitions, British examples and worked questions, written for you.' },
    ...
    exams: [
      { sel:'#examPickerArea, .xb-section, .ec-pick',
        ...
        body:'Choose Cambridge, Edexcel or A-Level / UCAS, then the subject and year you want to practice.' },
      { sel:'#examTimer',
    ...
    music: [
      { sel:'#kInstrumentPicker, .ki-pick, [data-kinstrument]',
        ...
        body:'Choose drums, piano, guitar, violin, bass, or world percussion (cajón, bodhrán, conga, bongos).' },
      ...
      { sel:'#kLoopGrid, .kl-grid',
        title:'3. Build a beat loop',
        body:'Tap cells in the grid to add hits. Toggle 8 or 16 steps and add bars (up to 16) for longer compositions.' },
    ...
    arena: [
      { sel:'#arenaClassTabs',
        ...
        body:'Kids (KS1–KS2), Lower Secondary (KS3), and IGCSE / A-Level all have their own rooms. You only see games made for your year group.' },
      { sel:'#arenaScopeTabs',
        title:'2. Choose Local, State or Nationwide',
        body:'Local = your school or area. National = all of the United Kingdom. International = students worldwide. Bigger scope = bigger prize, harder players.' },
      { sel:'#arenaRoomList',
      ...
      { sel:'#arenaLeaderboard',
        ...
        body:'Win games to earn ⭐ XP and rank up. Top players each weekend win prizes.' }
    ],
    theory: [
      ...
      { sel:'#essayTimer, .ttb-timer',
        ...
        body:'The timer matches the real Cambridge/Edexcel paper. The bar at the top warns you when 5 minutes are left.' },
  ...
  function autoBindPages(){
    ...
    var OBJECTIVES = {
      'learning': { title:'Why Learning', body:'Step through your week-by-week curriculum with DfE-aligned lessons, voice narration, diagrams and a built-in tutor that explains until you get it.' },
      'exams':    { title:'Why Exam Centre', body:'Practise Cambridge, Edexcel, A-Level / UCAS and KS3 Checkpoint under real timing with anti-cheat, instant marking and past-question banks per subject.' },
      'theory':   { title:'Theory Goal', body:'Write structured (a)(b)(c) answers like the real Cambridge booklet. Use the toolbar for symbols, equations, diagrams and tables. AI marks to Cambridge criteria.' },
      ...
      'arena':    { title:'Arena Goal', body:'Live multiplayer competitions grouped by class and region. Win XP, climb leaderboards, meet learners across the United Kingdom.' }
    };
