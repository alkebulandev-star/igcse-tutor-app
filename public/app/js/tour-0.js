...
(function(){
  ...
  var TOURS = {
    lesson: {
      ...
      accent: '#3b82f6',
      steps: [
        { ico:'1️⃣', h:'Read the lesson here', t:'The full lesson — definitions, British examples, worked questions — is written for you in this panel. Scroll through to read it all.' },
    ...
    objective: {
      ...
      steps: [
        ...
        { ico:'2️⃣', h:'Watch the timer', t:'Real exam mode is timed like the actual Cambridge/Edexcel/A-Level / UCAS paper. Pace yourself — don\'t spend too long on one question.' },
