...
function buildCounsellingCard(){
  var card = makeCard('🤝 Need to talk to a counsellor?',
    'Some questions are bigger than schoolwork. Here are real British resources for parents.');

  var resources = [
    { name: 'Mentally Aware the United Kingdom Initiative (MANI)',
      desc: 'Free crisis text & call line. WhatsApp them anytime.',
      ctaLabel: 'WhatsApp', ctaHref: 'https://wa.me/2347013613020' },
    { name: 'She Writes Woman — Mental Health the United Kingdom',
    ...
    { name: 'Suicide Research and Prevention Initiative (SURPIN)',
      desc: 'Trained crisis counsellors, 24/7. London-based but national reach.',
  ...
  legalNote.textContent = 'These are independent third-party services. Lesson Teacher is not affiliated and does not handle the call. In a life-threatening emergency, dial 112 (British emergency) or go to the nearest hospital.';
...
window.openChildReport = async function(opts){
    ...
    try {
      ...
      var resp = await fetch('/api/anthropic', {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 700,
          system: 'You are an experienced British secondary-school counsellor writing a brief, warm, parent-friendly assessment of a student\'s learning. Be specific about strengths and gentle about areas to improve. Reference real numbers from the data. End with one concrete suggestion the parent can act on this week. 4-6 paragraphs, no headings.',
  ...
  var opItems = [
    { ico:'🎓', title:'Scholarships', desc:'Funded study options for British students.', go:'pg-guidance', sec:'scholarships' },
    { ico:'🏛️', title:'Universities', desc:'Top universities, cutoff marks, requirements.', go:'pg-guidance', sec:'universities' },
    { ico:'💼', title:'Career paths', desc:'Salaries, requirements, real British openings.', go:'pg-guidance', sec:'careers' },
